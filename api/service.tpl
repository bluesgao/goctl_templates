...
func (s *{{.serviceName}}Service) {{.method}}(ctx context.Context, req *types.{{.request}}) (*types.{{.response}}, error) {
...
func (s *{{.serviceName}}Service) validateBusinessRules(ctx context.Context, req *types.{{.request}}) error {
	// TODO: 根据实际业务需求添加业务规则验证逻辑
	return nil
}

// prepareData 准备数据
func (s *{{.serviceName}}Service) prepareData(ctx context.Context, req *types.{{.request}}) (interface{}, error) {
	// TODO: 根据实际业务需求准备数据
	return nil, nil
} 